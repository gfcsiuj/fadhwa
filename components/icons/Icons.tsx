...
// Fix: Define a props type for icons to allow passing SVG attributes.
...
export const HeartIcon: React.FC<IconProps> = (props) => (
  <svg className="h-6 w-6" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export const ChevronRightIcon: React.FC<IconProps> = (props) => (
  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export const LightModeIcon: React.FC<IconProps> = (props) => (
  <svg className="switcher__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36 36" {...props}>
