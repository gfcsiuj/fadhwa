...
const ProductCard: React.FC<ProductCardProps> = ({ product, language, isFavorited: initialIsFavorited = false }) => {
  ...
  return (
    <div className="bg-[var(--c-bg)] rounded-lg shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <button className="w-full mt-auto bg-[var(--c-content)] text-[var(--c-bg)] py-2 px-4 rounded-md font-semibold hover:bg-[var(--c-accent)] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[var(--c-content)] focus:ring-opacity-50">
          {text.addToCart}
        </button>
      </div>
    </div>
